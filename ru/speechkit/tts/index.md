...
Синтез {{ speechkit-name }} имеет два API — API v1 ([REST](https://yandex.cloud/ru/docs/speechkit/tts/request)) и API v3 ([gRPC](https://yandex.cloud/ru/docs/speechkit/tts-v3/api-ref/grpc/), [REST](https://yandex.cloud/ru/docs/speechkit/tts-v3/api-ref)). На основе API v3 также реализован [Python SDK {{ speechkit-name }}](../sdk/python/index.md).
